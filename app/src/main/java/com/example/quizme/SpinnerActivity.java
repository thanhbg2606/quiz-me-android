...
public class SpinnerActivity extends AppCompatActivity {
    ...
    static final int DEDUCTION_COINS_15 = -15;
    @Override
        ...
        binding.spinBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                database.collection("users")
                        ...
                        .update("coins", FieldValue.increment(SpinnerActivity.DEDUCTION_COINS_15));

                Toast.makeText(getApplicationContext(), "Bạn bị trừ "+SpinnerActivity.DEDUCTION_COINS_15+ "coins", Toast.LENGTH_SHORT).show();
                Random r = new Random();
    ...
    void updateCash(int index) {
        ...
        database
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(SpinnerActivity.this, "Coins added "+ finalCash +" in account.", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
